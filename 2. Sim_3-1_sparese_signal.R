...
multiple <- function(size, numx, numxs, numnoise, XY, XSY, corr, 
                     xxs.non.miss.num, noise.non.miss.num){
  MSE <- matrix(NA, nrow=300, ncol=5)
  num.impu.merge <- c()
  num.impu.pair  <- c()
  for(sim in 1:300){
    set.seed(sim)
    signal   <- signal_data(numx = numx, numxs = numxs, size = size, XY = XY,
                            XSY = XSY,correlation = corr)
    noise    <- noise_data(number = numnoise, study  = 5, study_size = 100)
...
MSE1.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                  XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 1)
save(MSE1.noise, file = "MSE1131_noise.RData")

MSE2.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 2)
save(MSE2.noise, file = "MSE1132_noise.RData")

MSE3.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 3)
save(MSE3.noise, file = "MSE1133_noise.RData")

MSE4.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 4)
save(MSE4.noise, file = "MSE1134_noise.RData")

MSE5.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 5)
save(MSE5.noise, file = "MSE1135_noise.RData")

MSE6.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 6)
save(MSE6.noise, file = "MSE1136_noise.RData")

MSE7.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 7)
save(MSE7.noise, file = "MSE1137_noise.RData")

MSE8.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 8)
save(MSE8.noise, file = "MSE1138_noise.RData")

MSE9.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 3, noise.non.miss.num = 9)
save(MSE9.noise, file = "MSE1139_noise.RData")